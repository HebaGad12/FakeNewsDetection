...
{
    /// <inheritdoc />
    public partial class MergeOrganizationIntoUser : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Create Users table (with org fields merged in)
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JournalistExternalId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    // Organization-specific columns (null for non-org users)
                    License = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Profile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    // Self-referencing FK: journalist -> org user
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // OrganizationId now references Users (org user), not Organizations
                    OrganizationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    CommunityCredibilityPercent = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_Users_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interactions_PostId_UserId_Type",
                table: "Interactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModerationActions_PostId_CreatedAt",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WalletTransactions_Users_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(name: "IX_Donations_SenderId", table: "Donations", column: "SenderId");
            migrationBuilder.CreateIndex(name: "IX_Donations_RecipientId", table: "Donations", column: "RecipientId");

            // OrganizationFollows — FK to Users (org user)
            migrationBuilder.CreateTable(
            ...
            // OrganizationWallets — FK to Users (org user)
            migrationBuilder.CreateTable(
            ...
            // OrganizationWalletTransactions
            migrationBuilder.CreateTable(
