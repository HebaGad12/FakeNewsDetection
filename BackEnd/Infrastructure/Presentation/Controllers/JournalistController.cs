                    ...
                    if (isImage)
                    {
                        ...
                        if (check.IsDuplicate)
                            return BadRequest(new
                            {
                                ...
                                Message = $"Image '{file.FileName}' is already registered by another user.",
                                Matches = check.Matches   // list of { similarity, post }
                            });
                    }
            ...
            [FromBody] SetCopyrightRequest req)
        {
            ...
            if (req.IsCopyrighted && !item.IsCopyrighted)
            {
                ...
                if (check.IsDuplicate)
                    ...
                    {
                        Error   = "CopyrightViolation",
                        Message = "This image is already registered by another user.",
                        Matches = check.Matches   // list of { similarity, post }
                    });
